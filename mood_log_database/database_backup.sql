...
\restrict 5cqqsD1v6PEwYKPKkOs6c3cHVVI4ViEiHS7KcRJMJssPRpKcJxZU91Xm3BhzJNO
...
\unrestrict 5cqqsD1v6PEwYKPKkOs6c3cHVVI4ViEiHS7KcRJMJssPRpKcJxZU91Xm3BhzJNO
\connect myapp
\restrict 5cqqsD1v6PEwYKPKkOs6c3cHVVI4ViEiHS7KcRJMJssPRpKcJxZU91Xm3BhzJNO
...
--
-- Name: moods; Type: TABLE; Schema: public; Owner: appuser
--
...
CREATE TABLE public.moods (
    ...
    CONSTRAINT moods_mood_type_check CHECK ((mood_type = ANY (ARRAY['happy'::text, 'sad'::text, 'neutral'::text, 'anxious'::text, 'excited'::text, 'angry'::text, 'tired'::text, 'stressed'::text, 'grateful'::text, 'calm'::text])))
);


ALTER TABLE public.moods OWNER TO appuser;
...
--
-- Data for Name: moods; Type: TABLE DATA; Schema: public; Owner: appuser
--

COPY public.moods (id, user_id, mood_type, note, date, created_at) FROM stdin;
\.
...
1	000_extensions.sql	2025-12-12 07:03:14.314685+00
2	001_init.sql	2025-12-12 07:03:14.376105+00
3	002_indexes.sql	2025-12-12 07:03:14.423517+00
\.
...
--
-- Name: moods moods_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--
...
--
-- Name: moods moods_user_id_date_key; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.moods
    ADD CONSTRAINT moods_user_id_date_key UNIQUE (user_id, date);
...
--
-- Name: moods_user_date_idx; Type: INDEX; Schema: public; Owner: appuser
--

CREATE INDEX moods_user_date_idx ON public.moods USING btree (user_id, date);


--
-- Name: users_email_lookup_idx; Type: INDEX; Schema: public; Owner: appuser
--
...
--
-- Name: moods moods_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: appuser
--
